 ...
 * Full CRUD interface for managing student accounts
 */
export default function StudentsScreen() {
  const router = useRouter();
  const { students, isLoading, fetchUsers, createUser, updateUser, deleteUser } = useAdminUsers();
  ...
  const handleEdit = async () => {
    ...
    const result = await updateUser(selectedStudent.uid, input);
    setFormLoading(false);
  ...
  setFormLoading(true);
  const result = await deleteUser(selectedStudent.uid);
  setFormLoading(false);
  ...
  if (result.success) {
    ...
    setSelectedStudent(null);
    await fetchUsers('student'); // 👈 await so UI waits for fresh data
  } else {
  ...
  // Open delete modal
  const openDeleteModal = (student: AdminUser) => {
    setSelectedStudent(student);
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            >
              <ThemedText style={styles.createButtonText}>+ Add Student</ThemedText>
            </Pressable>
          </View>
        </View>
        ...
        <View style={styles.listSection}>
          {filteredStudents.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <ThemedText style={styles.emptyStateTitle}>No students found</ThemedText>
              ...
              <View key={student.uid} style={styles.studentCard}>
                <View style={styles.studentCardContent}>
                  ...
                  <View style={styles.studentAvatar}>
                    ...
                    {student.isOnline && <View style={styles.onlineBadge} />}
                  </View>

                  {/* Info */}
                  <View style={styles.studentInfo}>
                    <ThemedText style={styles.studentName}>{student.name || 'Unnamed'}</ThemedText>
      ...
      <Modal visible={showCreateModal} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <ThemedText style={styles.modalSubtitle}>Create a new student account</ThemedText>
            ...
            <View style={styles.modalActions}>
              ...
              >
                {formLoading ? (
                  ...
                  <ThemedText style={styles.modalSubmitButtonText}>Create Student</ThemedText>
                )}
              </Pressable>
            </View>
          </View>
      ...
      <Modal visible={showEditModal} transparent animationType="slide">
        ...
        <View style={styles.modalOverlay}
          ...
          onStartShouldSetResponder={() => true}>
            ...
            <ThemedText style={styles.modalSubtitle}>Update student information</ThemedText>
      ...
      <Modal visible={showDeleteModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <ThemedText style={styles.modalTitle}>Delete Student</ThemedText>
            <ThemedText style={styles.deleteWarningText}>
              Are you sure you want to delete <ThemedText style={styles.deleteWarningName}>{selectedStudent?.name}</ThemedText>?
